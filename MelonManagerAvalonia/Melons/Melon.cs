...
namespace MelonManagerAvalonia.Melons;
...
public class Melon
    {
        ...
        public static Melon Open(string path, Stream stream, bool showFailReason)
        {
            ...
            catch (BadImageFormatException)
            {
                ...
                //if (showFailReason)
                    //TODO CustomMessageBox.Error($"Failed to open '{path}': The selected DLL is not a valid .net library!");
                return null;
            }
            catch (Exception ex)
            {
                ...
                //if (showFailReason)
                    //TODO CustomMessageBox.Error($"Failed to open '{path}' as a Melon:\n\n{ex}");
                return null;
            }
            ...
            if (info == null)
            {
                ...
                //if (showFailReason)
                    //TODO CustomMessageBox.Error($"Failed to open '{path}' as a Melon: This DLL is not a valid Melon!");
                return null;
            }
